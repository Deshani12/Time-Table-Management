...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2024 at 09:20 AM
...
(2, 'A9876543210', 'Admin', 'Kamal', '12/11/2024', 'A98765432101718792069.png', '1234567890', 'male', 'no where');
...
(1, 'S1718791292', '1', '12A', 'A', '2024-06-19 15:32:37');

-- --------------------------------------------------------

--
-- Table structure for table `a_time_table`
--

CREATE TABLE `a_time_table` (
  `s_no` int(20) NOT NULL,
...
(3, 'E17187917486672ae442b976', 'Monthly test ', 'ALL', '8A', 'A', '100', '33', '2024-06-19 15:39:08'),
(4, 'E17187928006672b26095672', 'Software Engineering', 'Software Engineering', '8A', 'A', '100', '33', '2024-06-19 15:56:40'),
(5, 'E17187929656672b305cbb25', 'sldfj', 'ALL', '8B', 'A', '100', '33', '2024-06-19 15:59:25');
...
(1, 'E17187917486672ae442b976', 'Software Enineering', 'S1718791292', '86'),
(2, 'E17187917486672ae442b976', 'Data Science', 'S1718791292', '62'),
(3, 'E17187917486672ae442b976', 'English', 'S1718791292', '59'),
(4, 'E17187928006672b26095672', 'Cloud Computing', 'S1718791292', '33'),
(5, 'E17187929656672b305cbb25', 'Software Enginerring', 'S1718791292', '55'),
(6, 'E17187929656672b305cbb25', 'Business Manegmnet', 'S1718791292', '55'),
...
(1, 'A9876543210', 'A9876543210', '12c', 'Software Engineering', 'Software Engineering Quiz', 'do this on time', 'A98765432101718791715.png', '2024-06-19 15:38:35');
...
(68, 'T1718791191', 'Post a Quiz daily', 'completed'),
(69, 'T1718791191', 'Student meeting', 'pending'),
...
(1, 'S1718791292', 'Student', 'Kamala', 'father G', 'Male', '8A', 'A', '19-06-2024', 'S17187912921718791292.png', '7894561230', 'student@gmail.com', 'near teachers house', 'home town', '789654', 'Panjab', '', '', '');
...
(1, 'S1718791292', 'm piyasiri', '4567894562', 'Eum sit et laboriosa', 'Abbot', 'Hunter', 'Culpa odio laboriosa');
...
(1, '12c6672ac911a253', 'Software Engineering', '8A'),
(2, '12c6672ac9c45d68', 'Business Managemnt', '8B'),
(3, '12c6672aca78c3c7', 'English', '9A');
...
(12, '8A', 'Software Engineering', 'T17187911911718792274.png'),
(13, '9A', 'English', 'T17187911911718792285.png');

-- --------------------------------------------------------

--
-- Table structure for table `s_time_table`
--
...
--
-- Dumping data for table `s_time_table`
--

INSERT INTO `s_time_table` (`s_no`, `class`, `section`, `start_time`, `end_time`, `name`, `description`, `url`, `editor_id`, `timestamp`) VALUES
(1, 'class1', 'A', '2024-10-17T12:15', '2024-10-23T12:15', 'ABCs', 'test', '', '1', '2024-10-22 12:15:24');
...
(1, 'T1718791191', 'teacher', 'Nimal', '', 'Software engineerig', 'Male', '19-06-2024', 'T17187911911718792416.png', '7896541230', 'teacher@gmail.com', 'near admins house', 'home town', '478548', 'Delhi', '11A', 'A');
...
(1, 'T1718791191', 'piyasiri', '1234567895', 'Sit voluptas nisi v', 'Maggie', 'Mckee', 'Consequatur Volupta');
...
(9, '11c', 'A', 'se', '', '', '', '', '', '', '', 'T1718791191', '2024-10-22 09:50:36'),
(10, '11c', 'A', '', '', '', '', '', '', '', '', 'T1718791191', '2024-10-22 09:50:36'),
(11, '11c', 'A', '', '', '', '', '', '', '', '', 'T1718791191', '2024-10-22 09:50:36'),
(12, '11c', 'A', '', '', '', '', '', '', '', '', 'T1718791191', '2024-10-22 09:50:36'),
(13, '11c', 'A', '', '', '', '', '', '', '', '', 'T1718791191', '2024-10-22 09:50:36'),
(14, '11c', 'A', '', '', '', '', '', '', '', '', 'T1718791191', '2024-10-22 09:50:36'),
(15, '11c', 'A', '', '', '', '', '', '', '', '', 'T1718791191', '2024-10-22 09:50:36'),
(16, '11c', 'A', '', '', '', '', '', '', '', '', 'T1718791191', '2024-10-22 09:50:36'),
(17, '10', 'A', '', '', '', '', '', '', '', '', 'A9876543210', '2024-10-22 12:00:55'),
(18, '10', 'A', '', '', '', '', '', '', '', '', 'A9876543210', '2024-10-22 12:00:55'),
(19, '10', 'A', '', '', '', '', '', '', '', '', 'A9876543210', '2024-10-22 12:00:55'),
(20, '10', 'A', '', '', '', '', '', '', '', '', 'A9876543210', '2024-10-22 12:00:55'),
(21, '10', 'A', '', '', '', '', '', '', '', '', 'A9876543210', '2024-10-22 12:00:55'),
(22, '10', 'A', '', '', '', '', '', '', '', '', 'A9876543210', '2024-10-22 12:00:55'),
(23, '10', 'A', '', '', '', '', '', '', '', '', 'A9876543210', '2024-10-22 12:00:55'),
(24, '10', 'A', '', '', '', '', '', '', '', '', 'A9876543210', '2024-10-22 12:00:55');
...
--
-- Dumping data for table `t_time_table`
--

INSERT INTO `t_time_table` (`s_no`, `class`, `section`, `start_time`, `end_time`, `name`, `description`, `url`, `editor_id`, `timestamp`) VALUES
(1, 'class1', 'A', '2024-10-22T10:57', '2024-10-22T10:57', 'abcx', 'test', 'https://www.cinemalk.xyz/', '1', '2024-10-22 10:57:21');
...
--
-- Indexes for table `a_time_table`
--
ALTER TABLE `a_time_table`
  ADD PRIMARY KEY (`s_no`);
...
--
-- Indexes for table `s_time_table`
--
ALTER TABLE `s_time_table`
  ADD PRIMARY KEY (`s_no`);
...
--
-- AUTO_INCREMENT for table `a_time_table`
--
ALTER TABLE `a_time_table`
...
--
-- AUTO_INCREMENT for table `s_time_table`
--
ALTER TABLE `s_time_table`
  MODIFY `s_no` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
