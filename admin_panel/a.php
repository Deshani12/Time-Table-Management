...
if (isset($_POST['name'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO a_time_table (name, start_time, end_time, description, url, class, section, editor_id) VALUES (?, ?, ?, ?, ?, 'class1', 'A', '1')");
...
// Fetch Events
$result = $conn->query("SELECT * FROM a_time_table");
$events = [];
...
$(document).ready(function() {
    ...
    $('#saveEventBtn').on('click', function() {
        ...
        $.post('a.php', formData, function(response) {
            alert(response);
            location.reload();
        });
    });
